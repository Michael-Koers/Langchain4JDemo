...
public class EasyRAG {
    ...
    public static void main(String[] args) {
        ...
        var embeddingStore = loadDocument(Path.of("C:\\Users\\Michael\\Documents\\langchain\\Martin-and-Donny.txt"));
        ...
        String answer = assistant.chat("Where are Martin and Donny?");
